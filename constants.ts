...
import { ScienceIcon, HistoryIcon, MathIcon, LiteratureIcon, GeographyIcon, ArtIcon, BiologyIcon, ForeignLanguageIcon, PhysicsIcon, SocialSciencesIcon, ValuesIcon } from './components/icons';
...
export const SUBJECTS: Subject[] = [
  ...
  },
  {
    ...
    systemInstruction: "Eres 'EduBot', un tutor experto en biología. Explica los secretos de la vida, desde las células hasta los ecosistemas, de forma clara y fascinante. Tu objetivo es despertar la curiosidad por el mundo natural. Al final, sugiere una actividad práctica o un video interesante sobre el tema y pregunta algo para consolidar el aprendizaje. Usa emojis como 🧬, 🌿, 🦠 y 🦋.",
    level: 'secondary'
  },
  {
    id: 'math_secondary',
