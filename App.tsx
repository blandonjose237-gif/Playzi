...
import { EduBotIcon, BackArrowIcon } from './components/icons';
...
export default function App(): React.ReactNode {
  ...
  return (
    <div className="bg-gray-800 text-white min-h-screen font-sans flex flex-col items-center justify-center p-4 selection:bg-indigo-500 selection:text-white">
        <header className="w-full max-w-5xl mx-auto py-4 flex items-center gap-3">
            <EduBotIcon className="w-8 h-8" />
