...
import { SendIcon, ResetIcon, HomeIcon } from './icons';
...
const ChatWindow: React.FC<ChatWindowProps> = ({ messages, isLoading, onSendMessage, subject, onResetChat, onResetHome }) => {
