...
import { BackArrowIcon, RocketIcon, Grade1Icon, Grade2Icon, Grade3Icon, Grade4Icon, Grade5Icon, Grade6Icon, Grade7Icon, Grade8Icon, Grade9Icon, Grade10Icon, Grade11Icon } from './icons';
...
const SubjectSelector: React.FC<SubjectSelectorProps> = ({ subjects, onSelect }) => {
  const [selectedLevel, setSelectedLevel] = useState<'primary' | 'secondary'>('primary');
            ...
            <>
                ...
                {contentType === 'subjects' ? (
                    ...
                    <div className="w-full max-w-lg text-center flex flex-col items-center justify-center h-64 bg-gray-800/50 rounded-lg border-2 border-dashed border-gray-700 p-8">
                        ...
                        <h3 className="text-2xl font-bold text-white">¡Despegando Pronto!</h3>
                        <p className="text-gray-400 mt-2 max-w-sm">Estamos construyendo nuevas y emocionantes aventuras de aprendizaje. ¡Vuelve pronto para explorar!</p>
                    </div>
                )}
            </>
        );
